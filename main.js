let cameras = [
    {
        ...
        height: 1090,
        position: [
            0.13504381471084648, -1.2937689517667732, 5.205279542659445
        ],
        rotation: [
            [-0.9879986821377642,-0.00044860334246133186,-0.14407776667167585],
            [-0.014220344122028536,0.9946026355531322,0.05624392557283757],
            [0.14894798004320314,0.05545678938260555,-0.991029285012524]
        ],
...
let viewMatrix = getViewMatrix(cameras[0])
...
async function main() {
    ...
    const url = new URL(
        ...
        "https://samconsidine.github.io/splatv1/demo.splat",
    );
